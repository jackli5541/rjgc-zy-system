...
- 作业与提交：作业草稿和发布、附件管理、小组/个人作业提交、版本保留与撤回
- 评分与互评：教师评分、组内作品互评、量表统计、结果作废和成绩版本历史
- 教学辅助：站内通知、提交看板、批量下载、XLSX/CSV 导出和审计日志
- 文件处理：单文件最大 1 GB；PDF、图片和 Markdown 安全预览；DOCX、PPTX、XLSX 由后台任务转 PDF，未安装或转码失败时保留授权下载；ZIP/RAR/7Z 仅授权下载
