<script setup>
import { EyeOutlined, FileTextOutlined, InboxOutlined, PlusOutlined } from '@ant-design/icons-vue'
import { useShellContext } from '../../shellContext'
const { role, activeClasses, assignments, openAssignmentCreate, assignmentStateClass, openAssignment, formatTime, assignmentCountdown, statusLabel } = useShellContext()
</script>
