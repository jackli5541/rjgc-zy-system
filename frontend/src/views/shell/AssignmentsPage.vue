...
const { role, activeClasses, assignments, openAssignmentCreate, assignmentStateClass, openAssignment, openStudentAssignment, continueGrading, formatTime, assignmentCountdown, statusLabel, assignmentTypeLabel } = useShellContext()
