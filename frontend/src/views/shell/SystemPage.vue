...
const { audits, auditSearch, auditSemester, auditClassId, auditActorRole, auditSemesterOptions, auditClassOptions, auditPage, auditPageSize, auditTotal, loading, formatTime, actionLabel, objectLabel, roleLabel, searchAudits, changeAuditSemester, changeAuditPage } = useShellContext()
</script>
