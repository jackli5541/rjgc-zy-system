...
<template>
  <main class="login-page">
    <section class="login-visual">
      <div class="visual-inner"><div class="brand-mark large">SE</div><div class="visual-kicker">软件工程课程空间</div><h1>让作业流转<br><span>清晰、可追踪。</span></h1><p>从组队、选题到提交与互评，课程工作在一个空间内完成。</p></div>
    </section>
    <section class="login-panel">
      <div class="login-box">
        <div class="brand-row"><div class="brand-mark">SE</div><strong>软件工程作业系统</strong></div>
